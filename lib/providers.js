...
export async function callHeyGen({ avatarId, scriptText, voiceId, background = '#070710', backgroundUrl = null }) {
  // backgroundUrl = video URL → composited behind avatar
  // background    = hex colour → solid colour background (fallback)
  const bgLayer = backgroundUrl
    ? { type: 'video', url: backgroundUrl }
