...
export const NICHE_SETTINGS: Record<string, NicheSettings> = {
  ...
  history: {
    ...
    imagePromptPrefix: 'Period-accurate historical setting. Era-accurate clothing, weapons, and architecture for the specific period. No modern objects, no contemporary clothing, no synthetic materials, no electric lighting.',
    videoPromptPrefix: 'Historically authentic. Young adult male approximately 18-22 years old. Period-accurate wool or cotton uniform. Rough wooden furniture and barracks table. Bare incandescent bulb, candle, or oil lamp only — no electric fixtures. No modern objects. No contemporary furniture or decor.',
    negativePrompt: 'modern, contemporary, fluorescent light, plastic, synthetic, digital screen, smartphone, modern furniture, IKEA, sneakers, t-shirt, jeans, hoodie, modern lamp, neon, flowers in vases, potted plants, contemporary decor',
    cinemaStyle: 'Cinematic film grain, desaturated period-accurate colour palette, natural candlelight or single bare-bulb incandescent, slow deliberate camera movement',
    defaultDuration: 10,
