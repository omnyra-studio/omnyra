...
export const NICHE_SETTINGS: Record<string, NicheSettings> = {
  ...
  luxury: {
    ...
    videoPromptPrefix: 'Elegant aspirational lifestyle movement. Graceful daily habits showcasing refined success — sweeping establishing drone shot of high-end villa with ocean view, smooth tracking of elegant morning routines, serene wide lifestyle vision at golden hour. Slow deliberate gestures, person in premium attire interacting with luxury surroundings with sophistication.',
  ...
  'technology-ai': {
    ...
    videoPromptPrefix: 'Futuristic technology demonstration. Modern professional clearly demonstrating cutting-edge AI tool or gadget — clean establishing shot with slow push-in revealing sleek high-tech studio, dynamic orbiting demo shots showing real-world features, visionary wide reveal of future application. Sharp precise interaction with screens and devices, neon accent lighting, controlled cinematic motion.',
  ...
  'mental-health': {
    ...
    videoPromptPrefix: 'Calming mental health moment. Peaceful individual practicing mindfulness in serene natural environment with soft morning light — wide calming establishing shot, slow gentle close-up movements of breathing or grounding techniques, hopeful peaceful resolution. Gentle diffused lighting, subtle natural motion, tranquil atmosphere throughout.',
  ...
  relationships: {
    ...
    videoPromptPrefix: 'Heartfelt relationship moment. Warm approachable individuals with natural interactions demonstrating healthy connection — gentle establishing shot of cozy modern home or serene outdoor setting, intimate smooth tracking during genuine conversation, warm resolution wide shot showing emotional closeness. Natural expressions, subtle authentic movements, emotional yet tasteful atmosphere.',
  ...
  'pet-care': {
    ...
    videoPromptPrefix: 'Wholesome pet moment. Adorable dog or cat with expressive features in bright cozy home or sunny outdoor garden — cute establishing shot, playful tracking close-ups of training moments or heartwarming interactions, warm final heartfelt moment. Natural soft lighting, realistic fur and movement details, joyful atmosphere.',
  ...
  gaming: {
    ...
    videoPromptPrefix: 'Epic gaming content moment. Immersive game world environment with dynamic gameplay highlights and clear strategies — epic wide establishing shot of rich detailed game world, fast controlled action tracking of key gameplay moments, victorious climax shot. Vibrant in-game lighting, high detail textures, energetic yet smooth motion showcasing skill and strategy.',
  ...
  'animation-3d': {
    ...
    videoPromptPrefix: 'Pixar-quality 3D animated story moment. Expressive 3D character with detailed design on emotional journey through rich stylized world — dynamic establishing world shot, character-focused smooth tracking of story beats, climactic emotional resolution. Physically accurate lighting and shadows, detailed textures, flawless rigging with natural squash and stretch, cinematic storytelling.',
