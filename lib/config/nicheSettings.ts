...
export const NICHE_SETTINGS: Record<string, NicheSettings> = {
  ...
  fitness: {
    ...
    videoPromptPrefix: 'Motivational fitness transformation. Continue from last frame: maintain identical character, clothing, and lighting. Motion Brush: explosive athletic movement — lifting, running, jumping. Roger Deakins dramatic natural lighting. Camera: slow-motion on peak effort, then dynamic pull-back revealing full form.',
  ...
  'personal-finance-side-hustles': {
    ...
    videoPromptPrefix: 'Dynamic side hustle moment. Continue from last frame: preserve character and home office setting. Motion Brush: hands typing, checking phone earnings screen, packing orders. Roger Deakins warm practical indoor lighting. Camera: energetic tracking shot that follows the work flow.',
  ...
  motivation: {
    ...
    videoPromptPrefix: 'Cinematic motivational movement. Continue from last frame: maintain character pose and golden hour lighting. Motion Brush: forward walking motion, arms swinging, rising from ground. Roger Deakins golden hour backlighting, high contrast. Camera: slow push-in building to emotional close-up.',
  ...
  luxury: {
    ...
    videoPromptPrefix: 'Aspirational luxury lifestyle movement. Continue from last frame: preserve elegant character and premium environment perfectly. Motion Brush: slow deliberate gestures — reaching for champagne glass, walking along marble floor, gazing at ocean view. Roger Deakins golden hour through floor-to-ceiling windows. Camera: smooth slow dolly tracking elegant movement.',
    negativePrompt: 'blur, tacky, cheap looking, poor taste, unstable motion, low quality, broken, damaged, burnt, rusted, junkyard, trash, cluttered, poverty, discount, fast food',
    cinemaStyle: 'High-end cinematic, golden hour lighting, rich elegant color palette, sophisticated atmosphere, shallow depth of field, subtle film grain, magazine-quality composition',
    defaultDuration: 10,
  ...
  'technology-ai': {
    ...
    videoPromptPrefix: 'Futuristic tech explainer movement. Continue from last frame: keep professional and studio environment locked. Motion Brush: precise hands typing on holographic interface, swiping screens, pointing to displayed data. Blade Runner Deakins neon-accented clean lighting. Camera: controlled orbit around the demonstration, slow push-in on key screen.',
    negativePrompt: 'blur, outdated, buggy visuals, chaotic, low quality, distortion, medieval, ancient, rustic, farmhouse, candle, handwritten, no technology',
    cinemaStyle: 'Sleek futuristic cinematic, neon and clean lighting accents, sharp focus, cool blue tones, innovative atmosphere, smooth realistic motion',
    defaultDuration: 10,
    lightningModeDefault: true,
    eraDetection: false,
  ...
  'mental-health': {
    ...
    videoPromptPrefix: 'Calming mental health moment. Continue from last frame: preserve serene character and peaceful environment. Motion Brush: gentle deep breathing — chest rising slowly, hands relaxing open, head tilting softly. Roger Deakins soft diffused morning light. Camera: ultra-slow push-in to peaceful face, almost imperceptible movement.',
    negativePrompt: 'blur, triggering visuals, dark tones, chaotic motion, low quality, loud, aggressive, party, horror, violence, screaming, chaos, rave',
    cinemaStyle: 'Soft serene cinematic, gentle diffused lighting, peaceful muted color tones, very slow camera movement, intimate and safe, quiet pacing',
    defaultDuration: 10,
    lightningModeDefault: false,
    eraDetection: false,
  ...
  relationships: {
    ...
    videoPromptPrefix: 'Heartfelt relationship moment. Continue from last frame: preserve both characters and warm setting with perfect consistency. Motion Brush: gentle hand reach, leaning closer, shared glance with natural smile. Roger Deakins warm golden soft light. Camera: intimate smooth tracking during conversation, slight push-in on emotional connection.',
    negativePrompt: 'blur, toxic drama, exaggerated motion, low quality, arguing, fighting, screaming, violence, courtroom, lawyer, angry, revenge',
    cinemaStyle: 'Warm cinematic, soft natural lighting, emotional yet tasteful atmosphere, golden tones, intimate close-ups, gentle camera drift',
    defaultDuration: 10,
    lightningModeDefault: false,
    eraDetection: false,
  ...
  history: {
    ...
    videoPromptPrefix: 'Historically authentic cinematic scene. Continue from last frame: preserve exact period costume, lighting, and character position. Motion Brush: natural subtle breathing, slight weight shift, hands moving slowly on period props. Single bare incandescent bulb or candlelight only. Roger Deakins desaturated period-accurate shadows. Camera: slow deliberate push-in.',
  ...
  'beauty-skincare': {
    ...
    videoPromptPrefix: 'Luxurious beauty routine movement. Continue from last frame: preserve character, lighting setup, and product placement. Motion Brush: precise hand applying serum, smooth blending motion, gentle tapping on skin. Roger Deakins flattering soft ring-light warmth. Camera: extreme close-up on skin texture and product application.',
  ...
  productivity: {
    ...
    videoPromptPrefix: 'Crisp productivity moment. Continue from last frame: keep workspace, character, and natural window light identical. Motion Brush: hand writing in planner, checking off tasks, typing with purpose. Roger Deakins clean bright natural light. Camera: satisfying close-up on the completed task, slow pull-back to reveal organised workspace.',
  ...
  'business-entrepreneurship': {
    ...
    videoPromptPrefix: 'Sharp entrepreneurship moment. Continue from last frame: maintain professional character, office environment, and lighting. Motion Brush: confident stride, presenting to board, hands gesturing on strategy. Roger Deakins clean professional neutral light. Camera: purposeful tracking shot following decisive movement.',
  ...
  'pet-care': {
    ...
    videoPromptPrefix: 'Wholesome pet moment. Continue from last frame: preserve pet appearance, owner, and home environment exactly. Motion Brush: pet running joyfully, tail wagging, performing trick, jumping up to greet. Roger Deakins warm natural indoor light. Camera: dynamic handheld following pet movement, close-up on expressive animal face.',
    negativePrompt: 'blur, aggression, poor conditions, unnatural motion, low quality, hunting, animal harm, cramped cages, abuse, neglect, taxidermy',
  ...
  teens: {
    ...
    videoPromptPrefix: 'Vibrant teen lifestyle moment. Continue from last frame: preserve character, school environment, and bright daylight. Motion Brush: laughing with friends, walking through hallway, spontaneous reaction. Roger Deakins natural pop-bright daylight. Camera: energetic handheld following youth movement, fast cut rhythm.',
  ...
  'food-recipes': {
    ...
    videoPromptPrefix: 'Appetizing recipe moment. Continue from last frame: preserve chef, kitchen layout, and warm practical lighting. Motion Brush: chopping with rhythm, stirring bubbling pot, plating with precision. Roger Deakins warm overhead practical kitchen light with steam rising. Camera: close-up on food action, pull back to reveal full dish.',
  ...
  diy: {
    ...
    videoPromptPrefix: 'Satisfying DIY moment. Continue from last frame: preserve builder, workshop, and natural work lighting. Motion Brush: sawing with intention, hammering nails, painting smooth strokes, assembling final piece. Roger Deakins warm workshop practical light. Camera: close-up on skilled hands, pull-back to reveal transformation.',
  ...
  gaming: {
    ...
    videoPromptPrefix: 'Exciting gaming content. Continue from last frame: maintain game world environment and character consistency. Motion Brush: intense hands on keyboard/controller, eyes tracking rapidly, dramatic reaction moment. RGB dynamic monitor glow. Camera: fast controlled tracking on player reaction, cut to gameplay highlight, victorious pull-back.',
    negativePrompt: 'blur, low graphics, chaotic jitter, low quality, toxic behavior, spoilers, generic office, static boring setup',
    cinemaStyle: 'Vibrant cinematic gaming aesthetic, dramatic in-game lighting, high detail textures, energetic RGB glow, shallow DOF on player reaction, smooth controlled motion',
    defaultDuration: 10,
    lightningModeDefault: true,
    eraDetection: false,
  ...
  'product-reviews': {
    ...
    videoPromptPrefix: 'Honest product review moment. Continue from last frame: keep product, reviewer, and studio lighting consistent. Motion Brush: deliberate unboxing reveal, turning product to camera, demonstrating key feature. Roger Deakins clean neutral studio light. Camera: close-up on product detail, pull-back to show reviewer reaction.',
  ...
  'faceless-stoic': {
    ...
    videoPromptPrefix: 'Faceless stoic cinematic moment. Continue from last frame: preserve silhouette position and epic landscape lighting. Motion Brush: slow deliberate forward walk, environmental wind through coat, rain streaking, mist rolling in. Roger Deakins moody desaturated backlighting. Camera: slow pull-back to massive wide reveal of epic landscape.',
  ...
  'animation-3d': {
    ...
    videoPromptPrefix: 'Pixar-quality 3D animation. Continue from last frame: preserve character model, world design, and lighting rig exactly. Motion Brush: expressive character movement — squash and stretch walk, secondary hair and clothing motion, emotional facial expression. Physically accurate studio lighting. Camera: smooth cinematic tracking following character arc.',
    ...
    cinemaStyle: 'Pixar-quality 3D cinematic, detailed textures, physically accurate lighting and shadows, expressive character animation, vibrant saturated palette, rich world-building depth',
    defaultDuration: 10,
    lightningModeDefault: false,
    eraDetection: false,
