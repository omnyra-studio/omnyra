    ...
    <main style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: '"Instrument Sans","Inter",-apple-system,sans-serif', padding: "0 0 80px" }}>
      <div style={{ maxWidth: 520, margin: "0 auto", padding: "0 20px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "20px 0 20px" }}>
          ...
          <div>
            <h1 style={{ margin: 0, fontSize: 20, fontWeight: 700 }}>AI Voice Library</h1>
            <p style={{ margin: 0, fontSize: 12, color: C.sub }}>
              {loadingVoices ? "Loading..." : `${voices.length} voices · ElevenLabs`}
            </p>
          </div>
          {credits !== null && (
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          <div style={{ fontSize: 11, color: C.sub, marginTop: 4, textAlign: "right" }}>
            {text.length} chars · {text.length > 500 ? "2 credits" : "1 credit"}
          </div>
        </div>
